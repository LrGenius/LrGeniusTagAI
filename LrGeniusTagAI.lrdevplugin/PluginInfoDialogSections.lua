    ...
    return {

        {
            ...
            f:row {
                ...
                f:static_text {
                    title = LOC "$$$/lrc-ai-assistant/PluginInfoDialogSections/enablePerfLogging=Enable performance logging",
                    alignment = 'right',
...
function PluginInfoDialogSections.sectionsForTopOfDialog(f, propertyTable)
    ...
    return {

        {
            ...
            title = LOC "$$$/lrc-ai-assistant/PluginInfoDialogSections/header=LrGeniusTagAI configuration",
            ...
            f:group_box {
                ...
                f:row {
                    ...
                    f:static_text {
                        title = LOC "$$$/lrc-ai-assistant/ResponseStructure/Keywords=Keywords",
                    },
                    f:checkbox {
